...
class TeamController extends Controller
{
    ...
    public function __construct(TeamRequest $request, Team $model)
    {
...
//Insert Blog Gallary
            ...
            if ($this->request->ajax())
                return response()->json(array('status' => 'true', 'message' => "Add Team Done Sucessfully"));
            return redirect()->back()->with('success', "Add Team Done Sucessfully");
