...
class TabController extends Controller
{
    ...
    public function __construct(TabRequest $request, Tab $model)
    {
        $this->request = $request;
        $this->model = $model;
        $this->view = 'admin/tabs/';
    }
...
//Insert Blog Gallary
                ...
                if ($this->request->ajax())
                    return response()->json(array('status' => 'true', 'message' => "Add tag Done Sucessfully"));
                return redirect()->back()->with('success', "Add tag Done Sucessfully");
