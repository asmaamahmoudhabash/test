...
class AdsController extends Controller
{
    ...
    public function __construct(AdsRequest $request, Ads $model)
    {
...
//Insert Blog Gallary
            ...
            if ($this->request->ajax())
                return response()->json(array('status' => 'true', 'message' => "Add Ads Done Sucessfully"));
            return redirect()->back()->with('success', "Add Ads Done Sucessfully");
