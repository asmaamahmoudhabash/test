...
class ServiceimageController extends Controller
{
    ...
    public function __construct(ServiceimageRequest $request, Serviceimage $model)
    {
    ...
    public function index()
    {
        ...
        if (is_null($this->request->value)) {//
            ...
            $this->request->flash();
            $rows = $this->model->where('place', 'like', "%{$this->request->value}%")
                ->paginate(25);
        }
...
//Insert Blog Gallary
            ...
            if ($this->request->ajax())
                return response()->json(array('status' => 'true', 'message' => "Add image Done Sucessfully"));
            return redirect()->back()->with('success', "Add image Done Sucessfully");
