...
//Insert Blog Gallary
            ...
            if ($this->request->ajax())
                return response()->json(array('status' => 'true', 'message' => "Add slider Done Sucessfully"));
            return redirect()->back()->with('success', "Add slider Done Sucessfully");
