...
<tr id="trow_{{ $row->id }}">
    ...
    <td><strong>{{  substr($row->job_title_en,0,100) }}</strong></td>
    <td><img src="{{  asset('admin-assets/images/team/'.$row->image) }}" width="100" height="70"/></td>



    <td>
        <a class="btn btn-default btn-rounded btn-sm" href="{{ url('controll/teams/'.$row->id.'/edit') }}" ><span class="fa fa-pencil"></span></a>
        <!--       
